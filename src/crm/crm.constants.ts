 ...
 */
export const CRM_NON_OPERATIONAL_QUALITIES = [
  'TRACKING_ONLY',
  'JUNK',
  'DUPLICATE',
] as const;
 ...
 */
export const CRM_OPERATIONAL_QUALITY_SQL = `(lead_quality IS NULL OR lead_quality NOT IN ('TRACKING_ONLY', 'JUNK', 'DUPLICATE'))`;
 ...
 */
export function hasOperationalIdentity(lead: {
  phone?: string | null;
  email?: string | null;
 ...
 */
export function hasContactInfo(lead: {
  phone?: string | null;
  email?: string | null;
}): boolean {
  const phone = lead.phone?.trim();
